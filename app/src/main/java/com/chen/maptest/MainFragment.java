...
import com.chen.maptest.MyModel.SelectAreaData;
import com.chen.maptest.MyModel.SelectAreaResult;
...
public class MainFragment extends Fragment implements
    ...
    private void initLayout(){
        ...
        v1 = LayoutInflater.from(getActivity()).inflate(R.layout.layout_user_message,null,false);
        v2 = LayoutInflater.from(getActivity()).inflate(R.layout.layout_comment,null,false);
